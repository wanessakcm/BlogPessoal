...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) //Determina que a classe é derivada do spring boot test (caso a porta 8080 esteja ocupada, o spring vai definir outra porta automaticamente)
